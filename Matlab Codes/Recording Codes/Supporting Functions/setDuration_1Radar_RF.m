...
[~,Data_Matrix_1,bin_length,range_vector,total_time,info_1,frame_stamp_vec,queue,time_toc,recording_actual_time,frame_area_tot,range_vector_length]=rec_and_vis_data_1Radar_setDuration_RF(xep_1,frame_start,frame_stop,actual_fps,fps,total_duration,visualise_data,visualise_fps,calibration,freqRes_STFT);
