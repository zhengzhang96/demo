function [fh_baseband]=rec_and_vis_data_1Radar_varDuration_IQ_stream_walk_breath(xep_1,frame_start,frame_stop,actual_fps,fps,visualise_data,visualise_fps,calibration,freqRes_STFT)
...
%                 ph_doppler.CData = 20*log10(abs(conj(STFT))+eps);
                ...
                if sign(walking_speed)==1
                    ...
                    general_title.String = ['Recording Radar Data - Date: ' datestr(now, 'dd/mm/yyyy'),' , Time: ',datestr(now,'HH:MM:SS:FFF') newline ...
                                            'Status: \bf{\color{blue}APPROACHING}\rm, Walking velocity: ' sprintf(' \\bf%.3f\\rm',walking_speed) ' \bfm/s\rm, Location: ' sprintf(' \\bf%.0f\\rm',range_loc_torso) newline ...
                ...
                elseif sign(walking_speed)==-1
                    general_title.String = ['Recording Radar Data - Date: ' datestr(now, 'dd/mm/yyyy'),' , Time: ',datestr(now,'HH:MM:SS:FFF') newline ...
                                            'Status: \bf{\color{darkgreen}RECEDING  }\rm, Walking velocity: ' sprintf('\\bf%.3f\\rm',walking_speed) ' \bfm/s\rm, Location: ' sprintf(' \\bf%.0f\\rm',range_loc_torso) newline ...
                    ...
                    general_title.String = ['Recording Radar Data - Date: ' datestr(now, 'dd/mm/yyyy'),' , Time: ',datestr(now,'HH:MM:SS:FFF') newline ...
                                            'Status: \bf{\color{red}Still }\rm, Raspration rate: ' sprintf(' \\bf%.0f\\rm',abs(f_STFT(f_ind))) '\bf Hz\rm, Location: ' sprintf(' \\bf%.0f\\rm',range_loc_torso)  newline ...
