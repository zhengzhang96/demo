...
%Note: Data Matrix Initialisation is not possible since we have unknown
%recording duration. However, we preinitialise this to a length
%corresponding to 5 minutes of recording and then truncate the output.
...
tot_frame_num = ceil(total_duration*actual_fps); % Multiply by fps to find total number of frames.
...
% info_1 or info_2 will be zero anyway.
...
if visualise_data
    fh_baseband = figure('Name','Recording Baseband signals','NumberTitle','off','Position', [218 62 1100 700],'KeyPressFcn',@key_pressed_fcn);
