...
% % Sampling Rate of Radars:
% fs = 23.328e9;
% 
% % Set frequency band used by the radars.
...
[~,Data_Matrix_1,bin_length,range_vector,total_time,info_1,frame_stamp_vec,queue,time_toc,recording_actual_time,frame_area_tot,range_vector_length]=rec_and_vis_data_1Radar_varDuration_IQ(xep_1,frame_start,frame_stop,actual_fps,fps,visualise_data,visualise_fps,calibration,freqRes_STFT);
...
disp('Radar is reset and is ready to record new data.')
pause(0.5)
