function replay_RecordedData_RF(Data_Matrix_1,frame_axis,range_axis,actual_fps,visualise_fps,subj_name,time,recording_actual_time,total_time,frame_start,frame_stop,frame_stamp_vec,freqRes_STFT)
...
fh_RF = figure('Name','Replaying Recorded RF signals','NumberTitle','off','Position',[218 62 1100 700]);
